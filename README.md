...
To run the project:
1. Clone the ATM-Machine repo to your local machine and follow below steps. If not working try to download the Zip file and again follow below steps.
...
5. Open IntelliJ- Instead of "Open" directly, Use File->New->Project from Existing Source->Select the path to the folder
6. In command prompt or terminal run command : javac ATM.java
7. After completion your folder will contain 3 .class files
8. In command prompt/terminal run command: java ATM
9. To run Test files, select Test folder, than run the AccountTest.java

---
## Visual
After running the command in #8, you should see this interface:
